...
OPERATOR_KUSTOMIZATION_FILE="${WORKSPACE}/deploy/kustomize/operator/latest/kustomization.yaml"
...
CONTRAIL_KUSTOMIZATION_FILE="${WORKSPACE}/deploy/kustomize/contrail/1node/latest/kustomization.yaml"
